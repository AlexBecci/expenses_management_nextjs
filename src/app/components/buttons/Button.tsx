...
export const styleButton = `w-full flex  items-center justify-center gap-2 text-xs  ${backgroundColorButton} border border-gray-600/60 text-white py-2 rounded-md hover:bg-blue-600` 